...
export const SAMPLE_PROJECT_PRESETS: SampleProject[] = [
  {
    ...
    badge: 'Storage & Grid',
    icon: '⚡',
    description: 'Deploying a 10 MW / 1,000 MWh multi-day iron-air long-duration battery storage system (LDES) in Brooklyn to eliminate peak fossil peaker run hours and resolve transmission bottlenecks under Con Edison interconnection.',
    location: 'Brooklyn, NY',
    applicantType: 'business',
    estimatedCost: '25000000',
    trl: 6,
    timeline: '2026-2029',
    partners: 'Con Edison, NYSERDA, EPRI',
  ...
  },
  {
    ...
    icon: '🏢',
    description: 'Engineering and installing large-scale industrial high-temperature air-to-water heat pump networks (160°C) with thermal energy storage across multi-building commercial campuses in Albany.',
    location: 'Albany, NY',
    applicantType: 'consortium',
    estimatedCost: '8500000',
    trl: 5,
    timeline: '2026-2028',
    partners: 'National Grid, NYSERDA, NYPA',
  ...
  },
  {
    ...
    badge: 'H2 & E-Fuels',
    icon: '🧪',
    description: 'Demonstrating high-temperature solid oxide electrolyzer cells (SOEC) co-located with offshore wind power to produce clean hydrogen and green ammonia for heavy transportation.',
    location: 'Buffalo, NY',
    applicantType: 'university',
    estimatedCost: '15000000',
    trl: 4,
    timeline: '2026-2030',
    partners: 'US DOE, NYSERDA, University at Buffalo',
  ...
  },
  {
    ...
    trl: 6,
    timeline: '2026-2028',
    partners: 'Cornell University, NYSERDA, NYSEG',
