  ...
  const sections = [
    {
      ...
      content: 'The Energy Innovation Terminal and the U.S. Energy Innovation Database are independent, third-party research and computational analytics tools developed outside of any official government capacity. This platform is NOT an official tool, publication, or product of the New York State Energy Research and Development Authority (NYSERDA), the State of New York, the United States Department of Energy (DOE), the Advanced Research Projects Agency-Energy (ARPA-E), the California Energy Commission (CEC), the Massachusetts Clean Energy Center (MassCEC), the National Science Foundation (NSF), or any other federal, state, regional, or municipal governmental entity. No endorsement, partnership, sponsorship, or official affiliation by or with any government agency is stated or implied.'
    },
    {
      icon: FileText,
