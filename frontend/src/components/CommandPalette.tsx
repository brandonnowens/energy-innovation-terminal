...
const STATIC_ACTIONS = [
  { id: 'persona-investors', label: 'Switch View: Investors & Strategists', sub: 'Daily Digest, Capital Flows, Venture & IP, and Strategic Reports', to: '__persona_investor__', icon: TrendingUp, category: 'Front Doors' },
  { id: 'persona-innovators', label: 'Switch View: Innovators & Grant Seekers', sub: 'Match Engine, Solicitations, and Application Studio', to: '__persona_innovator__', icon: Lightbulb, category: 'Front Doors' },
  { id: 'persona-all', label: 'Switch View: All Modules', sub: 'Display all modules, directories, intelligence suites, and reference databases', to: '__persona_all__', icon: Layers, category: 'Front Doors' },
  ...
  { id: 'nav-digest', label: 'Daily Digest', sub: 'Morning intelligence briefing: new solicitations, deadlines, and award wire', to: '/digest', icon: Newspaper, category: 'Opportunities' },
  { id: 'nav-chat', label: 'Strategic Advisory', sub: 'AI research copilot grounded in 29,305 awards and 3,870 solicitations', to: '/chat', icon: MessageSquare, category: 'Research' },
  { id: 'nav-match', label: 'Match Engine', sub: 'Eligibility and capital stacking analysis', to: '/analyze', icon: Sliders, category: 'Opportunities' },
  { id: 'nav-proposals', label: 'Application Studio', sub: 'Project objectives, scoring review, and proposal builder', to: '/proposals', icon: FileEdit, category: 'Opportunities' },
  { id: 'nav-opps', label: 'Solicitations', sub: '3,870 active and historical funding opportunities', to: '/opportunities', icon: FileSearch, category: 'Opportunities' },
  { id: 'nav-awards', label: 'Awards', sub: '29,305 awards — $89B+ in tracked capital', to: '/awards', icon: Trophy, category: 'Awards' },
  { id: 'nav-venture-patents', label: 'Venture & IP', sub: 'USPTO Bayh-Dole patent citations and VC follow-on lineage', to: '/venture-patents', icon: Lightbulb, category: 'Awards' },
  { id: 'nav-results', label: 'Outcomes', sub: 'Benchmarks, ROI ratios, and verified success stories', to: '/results', icon: Scale, category: 'Awards' },
  { id: 'nav-orgs', label: 'Organizations', sub: '185 federal, state, and utility entities', to: '/organizations', icon: Building2, category: 'Directories' },
  { id: 'nav-programs', label: 'Programs', sub: '181 federal, state, and utility programs', to: '/programs', icon: Layers, category: 'Directories' },
  { id: 'nav-contacts', label: 'Contacts', sub: '3,090 energy innovation domain experts, PIs & agency officers', to: '/contacts', icon: BookUser, category: 'Directories' },
  ...
  { id: 'nav-strategy', label: 'Strategy', sub: 'Capital allocation, positioning, and portfolio strategy workspace', to: '/strategy', icon: Compass, category: 'Intelligence' },
  { id: 'nav-sankey', label: 'Capital Flows', sub: 'Trace funds from agencies through sectors to energy verticals', to: '/sankey', icon: GitMerge, category: 'Intelligence' },
  { id: 'nav-trends', label: 'Trends', sub: 'Longitudinal analytics and capital velocity', to: '/trends', icon: TrendingUp, category: 'Intelligence' },
  { id: 'nav-reports', label: 'Reports', sub: 'Policy strategy blueprints, technology domain briefs, and commercialization reports', to: '/reports', icon: FileText, category: 'Intelligence' },
  { id: 'nav-technologies', label: 'Technologies', sub: 'Engineering mechanics, fuel pathways, frontier targets, and capital evidence', to: '/technologies', icon: BookOpen, category: 'References' },
  { id: 'nav-policies', label: 'Policies', sub: 'IRA §45/§48 tax credits, elective direct pay, NFPA/UL codes, and state climate statutes', to: '/policies', icon: ShieldCheck, category: 'References' },
  ...
  { id: 'nav-updates', label: 'Feeds', sub: 'Audit feed of detected dataset updates', to: '/updates', icon: Activity, category: 'Data & Audit' },
  ...
  { id: 'nav-quick-start', label: 'Quick Start Guide', sub: 'Core pillars, recommended workflows, and shortcuts', to: '__quick_start_guide__', icon: Compass, category: 'System' },
  { id: 'nav-api-docs', label: 'Developers & API Docs', sub: 'OpenAPI docs, developer tools, and Python/cURL endpoints', to: '__api_modal__', icon: Terminal, category: 'Data & Audit' },
];
