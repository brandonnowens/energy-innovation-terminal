...
const STATIC_ACTIONS = [
  { id: 'nav-chat', label: 'Virtual Assistant', sub: 'Grounded RAG AI expert copilot with direct access to all 56k+ awards & 5.7k+ opportunities', to: '/chat', icon: Bot, category: 'AI Advisory' },
  { id: 'nav-match', label: 'Match Opportunities', sub: 'Deterministic eligibility and funding architecture engine', to: '/', icon: Sparkles, category: 'Opportunities' },
  { id: 'nav-opps', label: 'Opportunities & Grants', sub: '5,757 active and historical funding opportunities', to: '/opportunities', icon: FileSearch, category: 'Opportunities' },
  { id: 'nav-technologies', label: 'Technology & Fuels Reference', sub: 'Engineering mechanics, fuel pathways, 2026-2035 frontier targets, and database capital evidence', to: '/technologies', icon: BookOpen, category: 'References' },
  { id: 'nav-policies', label: 'Policy Reference', sub: 'Federal IRA §45/§48 tax credits, elective direct pay cash monetization, NFPA/UL safety codes, and state climate statutes', to: '/policies', icon: ShieldCheck, category: 'References' },
  { id: 'nav-dockets', label: 'Regulatory Reference', sub: 'Public Utility Commission dockets, large load interconnection & VPP tariffs', to: '/dockets', icon: Scale, category: 'References' },
  { id: 'nav-awards', label: 'Awards & Map', sub: '56,413 awards representing $104.16B tracked capital & 10k+ grid queues', to: '/awards', icon: Trophy, category: 'Awards' },
  { id: 'nav-venture-patents', label: 'Venture & Patents', sub: 'USPTO Bayh-Dole patent citations, $58.22B private VC syndicates & lineage graph', to: '/venture-patents', icon: Lightbulb, category: 'Awards' },
  { id: 'nav-results', label: 'Results & Outcomes', sub: 'Apples-to-apples benchmarks, ROI ratios, and verified success stories', to: '/results', icon: Scale, category: 'Awards' },
  { id: 'nav-orgs', label: 'Organizations', sub: 'Directory of 140+ federal, state, and utility entities', to: '/organizations', icon: Building2, category: 'Organizations' },
  { id: 'nav-programs', label: 'Programs', sub: '143 federal, state, and utility programs', to: '/programs', icon: Layers, category: 'Organizations' },
  { id: 'nav-contacts', label: 'Contacts', sub: 'Yellow pages of 3,090+ energy innovation domain experts, PIs & agency officers', to: '/contacts', icon: BookUser, category: 'Organizations' },
  { id: 'nav-network', label: 'Entity Network', sub: 'Ecosystem clustering, bridge entities, and co-investment', to: '/network', icon: Network, category: 'Organizations' },
  { id: 'nav-strategy', label: 'Strategy', sub: 'Interactive capital allocation, positioning, and portfolio strategy workspace', to: '/strategy', icon: Compass, category: 'Strategy & Analysis' },
  { id: 'nav-sankey', label: 'Funding Flows', sub: 'Trace funds from agencies through sectors to energy & deep tech verticals', to: '/sankey', icon: GitMerge, category: 'Strategy & Analysis' },
  { id: 'nav-trends', label: 'Trends', sub: 'Longitudinal analytics & capital velocity', to: '/trends', icon: TrendingUp, category: 'Strategy & Analysis' },
  { id: 'nav-reports', label: 'Executive Reports', sub: 'Macro & policy strategy blueprints, technology domain briefs, and commercialization reports', to: '/reports', icon: FileText, category: 'Strategy & Analysis' },
  { id: 'nav-proposals', label: 'Winning Proposals', sub: 'Explore won proposal precedents, work breakdown structures (SOPO) & CBP rubrics', to: '/proposals', icon: FileEdit, category: 'Application Studio' },
