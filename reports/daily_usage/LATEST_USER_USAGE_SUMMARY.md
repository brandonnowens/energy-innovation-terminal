...
> [!NOTE]
> This daily report tracks how anonymous visitors and registered users interact with the application, highlighting direct side-by-side volume comparisons between **Today** and **Yesterday**, active user reach, most visited platform pages, core capability rankings, session velocity, geographic distribution (State/City), traffic acquisition sources, and analytical feature utilization.

## 1. Executive User Usage Snapshot (Today vs. Yesterday & Lifetime Reach)
...
| **Custom Reports & Strategies** | **0** new | **0** new | **36** reports | **15** roadmaps | 12 saved custom filter views |
| **Registered Accounts** | **2** | **2** | **2** active | **2** verified | Enterprise, Pro, and Tiered accounts |

## 2. Today vs. Yesterday Engagement & Growth Comparison
...
| Rank | Capability / Feature Suite | Adoption Tier | Category | Primary Workspace | Today Calls | Yesterday Calls | 7-Day Total Calls | 7-Day Unique Visitors | Avg Latency | Platform Utility & Value |
| :---: | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| **#1** | **Daily Intelligence Briefing & Executive Digest** | Tier 1: High Velocity & Daily Active Driver | Market Intelligence | `/digest` | 4 | 47 | **139** | 30 | 184.5ms | Curated clean tech news, solicitations, policy dockets & daily executive briefings |
...
| **#10** | **Recipient Dossiers & Attribution Index** | Tier 3: Execution, Diligence & Ecosystem Suite | Historical Awards | `/attributions` | 2 | 14 | **18** | 2 | 190.1ms | Granular recipient profiles, historical win rates & co-funding track records |
| **#11** | **Ecosystem Knowledge Graph & Entity Network** | Tier 3: Execution, Diligence & Ecosystem Suite | Ecosystem Intelligence | `/network` | 16 | 2 | **18** | 16 | 8737.6ms | Interactive graph of 26k+ recipients, prime contractors & institutional co-funding links |
...
- **Average User Compliance Score**: **97.8%**
- **Won Proposals Count**: **60**

### User Proposal Pipeline Stages
| Pipeline Stage | Drafts Count |
| :--- | :--- |
| `award_won` | 60 |
| `red_team` | 5 |
| `cbp_compliance` | 1 |
...
- **FOA Solicitations Shredded**: **7**
- **Average Cost Share Mandated**: **20.0%**
- **Justice40 / CBP Mandated Solicitations**: **6**
- **Custom Reports Created**: **36**
- **Strategic Roadmaps Generated**: **15**
- **Saved Custom Filter Views**: **12**

## 8. 14-Day User Engagement & Action Velocity Matrix
