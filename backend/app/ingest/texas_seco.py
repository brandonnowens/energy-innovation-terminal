...
class TXSECOAdapter(BaseAdapter):
    source_name = "texas_seco"
    source_url = "https://comptroller.texas.gov/programs/seco/funding/"
    source_type = "html"
    authority_rank = 3
        ...
        try:
            ...
            if not source:
                source = Source(
                    ...
                    description="TX SECO Funding Opportunities",
            ...
            for link, title in matches:
                ...
                # Check topics
                topics = ['demonstration', 'loanstar', 'incubator', 'technology', 'facility energy']
