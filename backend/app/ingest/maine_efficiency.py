"""Efficiency Maine Trust API adapter."""
...
class MaineEfficiencyAdapter(BaseAdapter):
    """Adapter for Efficiency Maine Trust opportunities."""

    source_name = "maine_efficiency"
    source_url = "https://www.efficiencymaine.com/opportunities/"
    source_type = "html"
    authority_rank = 2
    agency = "Efficiency Maine"
    ...
    def ingest(self, db: Session) -> dict:
        ...
        seen = set()
        topics = ["innovation", "pilot", "heat pump", "demo", "clean energy", "efficiency"]
        ...
        for href, link_text in matches:
            ...
            detail_url = href if href.startswith('http') else f"https://www.efficiencymaine.com{href if href.startswith('/') else '/' + href}"
