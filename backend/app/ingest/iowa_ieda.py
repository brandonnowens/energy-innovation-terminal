...
class IAIEDAAdapter(BaseAdapter):
    source_name = "iowa_ieda"
    source_url = "https://opportunityiowa.gov/"
    source_type = "html"
    authority_rank = 3
        ...
        try:
            ...
            if not source:
                source = Source(
                    ...
                    description="IA IEDA Funding Opportunities",
            ...
            for link, title in matches:
                ...
                # Check topics
                topics = ['piee', 'energy center', 'r&d', 'grid modernization', 'alternative fuels']
