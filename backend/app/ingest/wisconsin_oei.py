...
class WIOEIAdapter(BaseAdapter):
    source_name = "wisconsin_oei"
    source_url = "https://psc.wi.gov/Pages/Programs/OEI/EnergyInnovationGrantProgram.aspx"
    source_type = "html"
    authority_rank = 3
        ...
        try:
            ...
            if not source:
                source = Source(
                    ...
                    description="WI OEI Funding Opportunities",
            ...
            for link, title in matches:
                ...
                # Check topics
                topics = ['grant', 'storage', 'alt fuels', 'feasibility', 'innovation', 'eigp']
