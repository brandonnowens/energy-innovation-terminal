...
class VAEnergyAdapter(BaseAdapter):
    """Adapter for Virginia Energy opportunities."""

    source_name = "virginia_energy"
    source_url = "https://www.energy.virginia.gov/"
    source_type = "html"
    authority_rank = 2
    agency = "VA Energy"
    ...
    def ingest(self, db: Session) -> dict:
        ...
        seen = set()
        topics = ["innovation", "bank", "nuclear", "hydrogen", "carbon capture", "storage", "power"]
        ...
        for href, link_text in matches:
            ...
            detail_url = href if href.startswith('http') else f"https://www.energy.virginia.gov{href if href.startswith('/') else '/' + href}"
