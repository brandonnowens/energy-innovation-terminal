"""Maryland Energy Administration API adapter."""
...
class MarylandMEAAdapter(BaseAdapter):
    """Adapter for Maryland MEA opportunities."""

    source_name = "maryland_mea"
    source_url = "https://energy.maryland.gov/"
    source_type = "html"
    authority_rank = 2
    agency = "MD MEA"
    ...
    def ingest(self, db: Session) -> dict:
        ...
        seen = set()
        topics = ["energy innovation", "challenge", "prize", "data center", "efficiency", "grant"]
        ...
        for href, link_text in matches:
            ...
            detail_url = href if href.startswith('http') else f"https://energy.maryland.gov{href if href.startswith('/') else '/' + href}"
