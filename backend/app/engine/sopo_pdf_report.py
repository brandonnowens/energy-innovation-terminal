...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_header_footer(self, page_count: int):
        ...
        self.drawString(54, 32, "U.S. ENERGY INNOVATION DATABASE — CLEAN ENERGY RESEARCH, LLC (terminal.aixenergy.io)")
...
def build_sopo_package_pdf(proposal_data: Dict[str, Any], output_stream: io.BytesIO) -> None:
    ...
    signoff_data = [
        [
            Paragraph(
                ...
                "<b>Published via Clean Energy Research, LLC:</b> terminal.aixenergy.io &bull; <b>Support:</b> info@aixenergy.io",
                table_cell_style
            )
        ]
    ]
    ...
    story.append(Spacer(1, 6))
    story.append(get_pdf_disclaimer_flowable(doc_width=504.0))
