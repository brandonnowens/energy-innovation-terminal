...
class RateLimitMiddleware(BaseHTTPMiddleware):
    """Production-grade in-memory rate limiter per client IP with reverse-proxy support."""

    def __init__(self, app, default_rpm: int = 120, contact_rpm: int = 10, export_rpm: int = 20):
        super().__init__(app)
